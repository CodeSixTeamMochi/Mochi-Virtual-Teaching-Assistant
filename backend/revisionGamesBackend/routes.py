...
# Import your thread-safe connection pool functions
...
def create_category():
    return jsonify({"id": 1, "name": "Mock Category"}), 201
...
def save_activity():
    ...
    try:
        ...
        with conn.cursor(cursor_factory=psycopg2.extras.RealDictCursor) as cur:
            # Insert into the single revision_games table
            cur.execute(
                """
            ...
            # Convert datetime to ISO string for JSON parsing
